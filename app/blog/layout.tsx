  ...
  return (
    <div className="scrollbar-hide h-dvh overflow-y-auto">
        ...
        <div className="mx-auto max-w-2xl px-8">
          {/* Top bar */}
          <div className="flex items-center justify-end pt-24 pb-0">
            <CopyButton />
          </div>

          <main className="prose prose-gray mt-10 pb-20 prose-h4:prose-base dark:prose-invert prose-h1:text-xl prose-h1:font-medium prose-h2:mt-12 prose-h2:scroll-m-20 prose-h2:text-lg prose-h2:font-medium prose-h3:text-base prose-h3:font-medium prose-h4:font-medium prose-h5:text-base prose-h5:font-medium prose-h6:text-base prose-h6:font-medium prose-strong:font-medium">
            {children}
          </main>
